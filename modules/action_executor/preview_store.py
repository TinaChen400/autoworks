...
CAPTURE_PATH = RUNTIME_DIR / "latest_capture.png"
...
CLICK_PREVIEW_PATH = RUNTIME_DIR / "latest_click_preview.png"
...
def load_inputs() -> tuple[dict[str, Any], dict[str, Any] | None, dict[str, Any]]:
    return (
        load_json(EXECUTION_GATE_PATH),
        load_optional_json(SCHEDULER_RUN_PATH),
